    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Moderation', 'Moderatsiya'), ('New', 'Yangi'), ('Approved', 'Tasdiqlangan'), ('Canceled', 'Bekor qilingan')], default='New', max_length=50, verbose_name='Homiy holati')),
